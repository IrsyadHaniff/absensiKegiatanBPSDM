...
(function () {
  ...
  /** Tampilkan notifikasi sukses di halaman (tanpa alert bawaan browser) */
  function showSuccessMessage(msg) {
    var existing = document.getElementById("presensi-success-toast");
    if (existing) existing.remove();

    var toast = document.createElement("div");
    toast.id = "presensi-success-toast";
      ...
      fetch(APPS_SCRIPT_URL, {
        ...
        .then(function (result) {
          if (result.success) {
            ...
            showSuccessMessage("Presensi berhasil! Tanda tangan tersimpan di Google Drive.");
